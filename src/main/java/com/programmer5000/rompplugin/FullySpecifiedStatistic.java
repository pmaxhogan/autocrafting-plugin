...
public class FullySpecifiedStatistic {
  ...
  enum StatisticsToNames {
    ...
    BREWINGSTAND_INTERACTION("Opened: Brewing Stands"),
    BEACON_INTERACTION("Interactions with Beacon"),
    DROPPER_INSPECTED("Opened: Droppers"),
    HOPPER_INSPECTED("Opened: Hoppers"),
    INTERACT_WITH_LECTERN("Opened: Lecterns"),
    DISPENSER_INSPECTED("Opened: Dispensers"),
    ...
    ENDERCHEST_OPENED("Opened: Enderchests"),
    ITEM_ENCHANTED("Items Enhcanted"),
    RECORD_PLAYED("Discs Played"),
    FURNACE_INTERACTION("Opened: Furnaces"),
    CRAFTING_TABLE_INTERACTION("Opened: Crafting Tables"),
    CHEST_OPENED("Opened: Chests"),
    SLEEP_IN_BED("Times Slept"),
    SHULKER_BOX_OPENED("Opened: Boxes"),
    ...
    INTERACT_WITH_BLAST_FURNACE("Opened: Blast Furnace"),
    INTERACT_WITH_SMOKER("Opened: Smoker"),
    INTERACT_WITH_CAMPFIRE("Opened: Campfire"),
    INTERACT_WITH_CARTOGRAPHY_TABLE("Opened: Cartography Table"),
    INTERACT_WITH_LOOM("Opened: Loom"),
    INTERACT_WITH_STONECUTTER("Opened: Stonecutter"),
    INTERACT_WITH_ANVIL("Opened: Anvil"),
    INTERACT_WITH_GRINDSTONE("Opened: Grindstone"),
    INTERACT_WITH_SMITHING_TABLE("Opened: Smithing Table"),
